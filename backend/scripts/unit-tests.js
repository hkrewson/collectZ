...
results.push(run('drawer optional metadata primitives render compact rows with adaptive condition labels', () => {
  ...
  assert.ok(appPrimitivesSource.includes('function buildGradingMetadata({ trait = null, mediaType = \'\', ownerType = \'\' } = {})'));
  assert.ok(appPrimitivesSource.includes('function buildProvenanceMetadata({ trait = null } = {})'));
  assert.ok(appPrimitivesSource.includes('function buildObjectRelationshipMetadata({ relationships = [], loading = false } = {})'));
  ...
  assert.ok(appPrimitivesSource.includes("displayPriority: 30"));
  assert.ok(appPrimitivesSource.includes("displayPriority: 40"));
  assert.ok(appPrimitivesSource.includes("displayPriority: 50"));
  assert.ok(appPrimitivesSource.includes("form: 'edition_variant'"));
  assert.ok(appPrimitivesSource.includes("form: 'grading'"));
  assert.ok(appPrimitivesSource.includes("form: 'provenance'"));
  assert.ok(appPrimitivesSource.includes("form: 'object_relationship'"));
  assert.ok(appPrimitivesSource.includes("id: 'proof'"));
  assert.ok(appPrimitivesSource.includes("id: 'related'"));
  assert.ok(appPrimitivesSource.includes("id: normalizedOwner === 'art'"));
  assert.ok(appPrimitivesSource.includes("? 'authentication'"));
  assert.ok(appPrimitivesSource.includes("? 'condition' : 'grading'"));
  ...
  assert.ok(appPrimitivesSource.includes("summary: trait?.summary || ''"));
