...
results.push(run('edition boundary source includes backend-owned homelab shell and help surface rules', () => {
  ...
  assert.ok(publicExportSanitizationDocSource.includes('Audited frontend source and the OpenAPI contract can be exported once `npm run audit:public-source-boundary` reports zero findings.'));
