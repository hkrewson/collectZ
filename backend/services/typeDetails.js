const TYPE_DETAILS_ALLOWED_BY_MEDIA_TYPE = {
  ...
  book: [
    ...
    'kavita_series_id',
    'kavita_series_name',
    'kavita_localized_name',
    'kavita_original_name',
    'kavita_sort_name',
    'kavita_title_parse_status',
    'kavita_issue_title',
    'kavita_format',
    'kavita_pages',
    'kavita_cover_image',
    ...
    'kavita_launch_url',
    'kavita_launch_label',
    'kavita_launch_target',
    'kavita_volume_detail_status',
    'kavita_volume_count',
    'kavita_chapter_count',
    'kavita_volume_numbers',
    'kavita_first_volume_number',
    'kavita_first_chapter_id',
    'kavita_first_chapter_number',
    'kavita_first_chapter_title',
    'kavita_first_chapter_release_date',
    'kavita_first_chapter_pages',
    'kavita_chapter_titles',
    'kavita_chapter_pages_total',
    'kavita_chapter_fanout',
    'kavita_chapter_id',
    'kavita_volume_id',
    'kavita_chapter_number',
    'kavita_chapter_title',
    'kavita_chapter_sort_order',
    'kavita_chapter_release_date',
    'kavita_chapter_pages',
    'kavita_chapter_special',
    'kavita_parent_provider_item_id',
    'kavita_series_provider_item_id',
