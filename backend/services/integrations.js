...
const normalizeIntegrationRecord = (row) => {
  ...
  return {
    ...
    plexWebhookReceiverLastAttemptAt: row?.plex_webhook_receiver_last_attempt_at || null,
    plexWebhookReceiverLastAttemptStatus: row?.plex_webhook_receiver_last_attempt_status || null,
    plexWebhookReceiverLastAttemptError: row?.plex_webhook_receiver_last_attempt_error || null,
    plexWebhookReceiverLastContentType: row?.plex_webhook_receiver_last_content_type || null,
