...
- Keep platform member management separate from tenant invite history; `Platform > Members` should manage accounts and recovery actions, while scoped invites remain in tenant workspace controls.
...
- Child items list libraries for the active workspace.
