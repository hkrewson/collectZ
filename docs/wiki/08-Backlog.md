...
49. `Kavita Comic Series Title Normalization and Issue Mapping` was promoted as `3.4.153`; keep true chapter unread, broader annual/special import handling, embedded reader ownership, PDF/raw chapter file proxying, background polling, KOReader sync, and shared provider abstractions separate.
