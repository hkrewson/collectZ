...
- Removed the old unreachable Core handlers/modules for support request APIs, platform docs/metrics, global admin spaces/users/email-delivery, and platform-only integration diagnostics after confirming those paths are blocked or owned by `cairn`.
