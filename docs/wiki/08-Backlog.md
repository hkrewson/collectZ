...
**Status:** Active remediation is being promoted into numbered roadmap slices, including `3.16.21 — CodeQL Backend Input Boundary Hardening`, `3.16.22 — CodeQL SQL and URL Host Remediation`, `3.16.23 — CodeQL Log Hygiene and Unused Finding Triage`, `3.16.24 — CodeQL Sanitizer and Runtime Helper Remediation`, `3.16.26 — CodeQL Media Title Sanitizer Precision`, `3.16.27 — CodeQL Request Forgery Boundary Triage`, `3.16.28 — CodeQL Clean-Checkout Baseline Parity Policy`, `3.16.29 — CodeQL Maintained-Source Unused Finding Triage`, and `3.16.30 — CodeQL Maintained-Source Quality Finding Triage`.
