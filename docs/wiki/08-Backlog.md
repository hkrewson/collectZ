...
48. `Plex PMS API Modernization Foundation` was promoted as `3.4.111`; the provider-discovery runtime proof was promoted as `3.4.112`; keep Now Playing UI, Plex webhooks, scheduled sync cadence, and broad import rewrites separate.
