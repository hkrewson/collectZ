...
- No new required environment variables were introduced in this milestone.
- Existing deployments can continue using current `.env` values.
- Legacy links using `library-other` are compatibility-mapped to Comic Books.
