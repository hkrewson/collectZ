...
- Version: `3.12.7`
- Generated: `2026-06-05T01:43:54.902Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.12.7
- Release note presence: PASS — docs/releases/v3.12.7.md
...
- Observability release evidence: PASS — observability artifact present for 3.12.7 with 9/9 checks passed
...
- `docs/releases/v3.12.7.md`: present
