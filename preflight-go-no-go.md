...
- Version: `3.4.149`
- Generated: `2026-05-10T01:03:50.186Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.4.149
- Release note presence: PASS — docs/releases/v3.4.149.md
...
- Observability release evidence: PASS — observability artifact present for 3.4.149 with 9/9 checks passed
...
- `docs/releases/v3.4.149.md`: present
