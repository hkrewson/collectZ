...
- Version: `3.8.4`
- Generated: `2026-05-18T22:52:16.877Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.8.4
- Release note presence: PASS — docs/releases/v3.8.4.md
...
- Observability release evidence: PASS — observability artifact present for 3.8.4 with 9/9 checks passed
...
- `docs/releases/v3.8.4.md`: present
