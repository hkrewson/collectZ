...
- Version: `3.9.5`
- Generated: `2026-05-21T00:45:24.459Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.9.5
- Release note presence: PASS — docs/releases/v3.9.5.md
...
- `docs/releases/v3.9.5.md`: present
