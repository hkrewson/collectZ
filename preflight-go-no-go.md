...
- Version: `3.12.15`
- Generated: `2026-06-05T06:39:31.196Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.12.15
- Release note presence: PASS — docs/releases/v3.12.15.md
...
- Observability release evidence: PASS — observability artifact present for 3.12.15 with 9/9 checks passed
...
- `docs/releases/v3.12.15.md`: present
