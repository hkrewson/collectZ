...
- Version: `3.18.6`
- Generated: `2026-06-13T09:12:16.365Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.18.6
- Release note presence: PASS — docs/releases/v3.18.6.md
...
- Observability release evidence: PASS — observability artifact present for 3.18.6 with 9/9 checks passed
...
- `docs/releases/v3.18.6.md`: present
