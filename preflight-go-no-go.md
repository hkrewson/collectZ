...
- Version: `3.4.53`
- Generated: `2026-05-01T06:30:57.285Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.4.53
- Release note presence: PASS — docs/releases/v3.4.53.md
...
- `docs/releases/v3.4.53.md`: present
