...
- Version: `3.4.128`
- Generated: `2026-05-09T02:46:30.653Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.4.128
- Release note presence: PASS — docs/releases/v3.4.128.md
...
- Observability release evidence: PASS — observability artifact present for 3.4.128 with 9/9 checks passed
...
- `docs/releases/v3.4.128.md`: present
