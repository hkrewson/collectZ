...
- Version: `3.4.126`
- Generated: `2026-05-08T06:29:54.190Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.4.126
- Release note presence: PASS — docs/releases/v3.4.126.md
...
- Observability release evidence: PASS — observability artifact present for 3.4.126 with 9/9 checks passed
...
- `docs/releases/v3.4.126.md`: present
