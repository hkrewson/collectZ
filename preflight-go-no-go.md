...
- Version: `3.9.7`
- Generated: `2026-05-21T01:44:17.572Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.9.7
- Release note presence: PASS — docs/releases/v3.9.7.md
...
- `docs/releases/v3.9.7.md`: present
