...
- Version: `3.4.11`
- Generated: `2026-04-26T17:53:18.811Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.4.11
- Release note presence: PASS — docs/releases/v3.4.11.md
...
- Observability release evidence: PASS — observability artifact present for 3.4.11 with 9/9 checks passed
...
- `docs/releases/v3.4.11.md`: present
