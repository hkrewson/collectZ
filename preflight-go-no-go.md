...
- Version: `3.4.108`
- Generated: `2026-05-06T21:46:21.527Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.4.108
- Release note presence: PASS — docs/releases/v3.4.108.md
...
- Observability release evidence: PASS — observability artifact present for 3.4.108 with 9/9 checks passed
...
- `docs/releases/v3.4.108.md`: present
