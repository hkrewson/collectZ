...
- Version: `3.2.3`
- Generated: `2026-04-20T06:23:35.969Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.2.3
- Release note presence: PASS — docs/releases/v3.2.3.md
...
- Observability release evidence: PASS — observability artifact present for 3.2.3 with 9/9 checks passed
...
- `docs/releases/v3.2.3.md`: present
