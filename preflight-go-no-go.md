...
- Version: `3.4.86`
- Generated: `2026-05-04T00:58:13.758Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.4.86
- Release note presence: PASS — docs/releases/v3.4.86.md
...
- Observability release evidence: PASS — observability artifact present for 3.4.86 with 9/9 checks passed
...
- `docs/releases/v3.4.86.md`: present
