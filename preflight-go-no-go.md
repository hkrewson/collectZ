...
- Version: `3.9.6`
- Generated: `2026-05-21T01:06:13.150Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.9.6
- Release note presence: PASS — docs/releases/v3.9.6.md
...
- `docs/releases/v3.9.6.md`: present
