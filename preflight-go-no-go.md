...
- Version: `3.4.147`
- Generated: `2026-05-09T22:02:55.742Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.4.147
- Release note presence: PASS — docs/releases/v3.4.147.md
...
- Observability release evidence: PASS — observability artifact present for 3.4.147 with 9/9 checks passed
...
- `docs/releases/v3.4.147.md`: present
