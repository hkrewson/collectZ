...
- Version: `3.22.0`
- Generated: `2026-06-30T04:50:35.035Z`
- Base URL: `http://localhost:3218`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.22.0
- Release note presence: PASS — docs/releases/v3.22.0.md
- Backend dependency audit: PASS — using existing audit artifact; low=0 moderate=0 high=0 critical=0
- Frontend dependency audit: PASS — using existing audit artifact; low=0 moderate=0 high=0 critical=0
- Migration evidence presence: PASS — init parity and migration rehearsal evidence are present
- Observability release evidence: PASS — observability artifact present for 3.22.0 with 9/9 checks passed
...
- `docs/releases/v3.22.0.md`: present
