...
- Version: `3.4.99`
- Generated: `2026-05-05T05:32:22.469Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.4.99
- Release note presence: PASS — docs/releases/v3.4.99.md
...
- Observability release evidence: PASS — observability artifact present for 3.4.99 with 9/9 checks passed
...
- `docs/releases/v3.4.99.md`: present
