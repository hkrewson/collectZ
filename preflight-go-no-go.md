...
- Version: `3.10.14`
- Generated: `2026-06-02T04:36:08.051Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.10.14
- Release note presence: PASS — docs/releases/v3.10.14.md
...
- Observability release evidence: PASS — observability artifact present for 3.10.14 with 9/9 checks passed
...
- `docs/releases/v3.10.14.md`: present
