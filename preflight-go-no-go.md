...
- Version: `3.8.6`
- Generated: `2026-05-19T04:03:10.750Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.8.6
- Release note presence: PASS — docs/releases/v3.8.6.md
...
- Observability release evidence: PASS — observability artifact present for 3.8.6 with 9/9 checks passed
...
- `docs/releases/v3.8.6.md`: present
