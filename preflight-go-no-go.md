...
- Version: `3.4.35`
- Generated: `2026-04-29T03:55:11.670Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.4.35
- Release note presence: PASS — docs/releases/v3.4.35.md
...
- Observability release evidence: PASS — observability artifact present for 3.4.35 with 9/9 checks passed
...
- `docs/releases/v3.4.35.md`: present
