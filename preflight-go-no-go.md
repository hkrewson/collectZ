...
- Version: `3.4.160`
- Generated: `2026-05-17T00:48:02.769Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.4.160
- Release note presence: PASS — docs/releases/v3.4.160.md
...
- Observability release evidence: PASS — observability artifact present for 3.4.160 with 9/9 checks passed
...
- `docs/releases/v3.4.160.md`: present
