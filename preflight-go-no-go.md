...
- Version: `3.4.129`
- Generated: `2026-05-09T03:21:41.454Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.4.129
- Release note presence: PASS — docs/releases/v3.4.129.md
...
- Observability release evidence: PASS — observability artifact present for 3.4.129 with 9/9 checks passed
...
- `docs/releases/v3.4.129.md`: present
