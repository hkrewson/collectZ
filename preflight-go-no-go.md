...
- Version: `3.4.144`
- Generated: `2026-05-09T20:58:36.077Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.4.144
- Release note presence: PASS — docs/releases/v3.4.144.md
...
- Observability release evidence: PASS — observability artifact present for 3.4.144 with 9/9 checks passed
...
- `docs/releases/v3.4.144.md`: present
