...
- Version: `3.4.161`
- Generated: `2026-05-17T02:28:22.187Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.4.161
- Release note presence: PASS — docs/releases/v3.4.161.md
...
- Observability release evidence: PASS — observability artifact present for 3.4.161 with 9/9 checks passed
...
- `docs/releases/v3.4.161.md`: present
