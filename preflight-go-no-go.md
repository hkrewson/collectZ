...
- Version: `3.12.8`
- Generated: `2026-06-05T02:03:39.571Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.12.8
- Release note presence: PASS — docs/releases/v3.12.8.md
...
- Observability release evidence: PASS — observability artifact present for 3.12.8 with 9/9 checks passed
...
- `docs/releases/v3.12.8.md`: present
