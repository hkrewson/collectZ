...
- Version: `3.4.146`
- Generated: `2026-05-09T21:40:33.031Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.4.146
- Release note presence: PASS — docs/releases/v3.4.146.md
...
- Observability release evidence: PASS — observability artifact present for 3.4.146 with 9/9 checks passed
...
- `docs/releases/v3.4.146.md`: present
