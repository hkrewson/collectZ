...
- Version: `3.7.4`
- Generated: `2026-05-18T03:03:49.819Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.7.4
- Release note presence: PASS — docs/releases/v3.7.4.md
...
- Observability release evidence: PASS — observability artifact present for 3.7.4 with 9/9 checks passed
...
- `docs/releases/v3.7.4.md`: present
