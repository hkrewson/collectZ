...
- Version: `3.4.52`
- Generated: `2026-05-01T06:03:58.943Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.4.52
- Release note presence: PASS — docs/releases/v3.4.52.md
...
- `docs/releases/v3.4.52.md`: present
