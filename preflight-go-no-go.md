...
- Version: `3.4.46`
- Generated: `2026-05-01T03:00:19.282Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.4.46
- Release note presence: PASS — docs/releases/v3.4.46.md
...
- Observability release evidence: PASS — observability artifact present for 3.4.46 with 9/9 checks passed
...
- `docs/releases/v3.4.46.md`: present
