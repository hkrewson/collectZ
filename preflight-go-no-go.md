...
- Version: `3.20.10`
- Generated: `2026-06-26T05:13:45.551Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.20.10
- Release note presence: PASS — docs/releases/v3.20.10.md
...
- Observability release evidence: PASS — observability artifact present for 3.20.10 with 9/9 checks passed
...
- `docs/releases/v3.20.10.md`: present
