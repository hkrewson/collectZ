...
- Version: `3.8.11`
- Generated: `2026-05-19T06:19:09.392Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.8.11
- Release note presence: PASS — docs/releases/v3.8.11.md
...
- Observability release evidence: PASS — observability artifact present for 3.8.11 with 9/9 checks passed
...
- `docs/releases/v3.8.11.md`: present
