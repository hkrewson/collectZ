...
- Version: `3.8.0`
- Generated: `2026-05-18T04:36:41.631Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.8.0
- Release note presence: PASS — docs/releases/v3.8.0.md
...
- Observability release evidence: PASS — observability artifact present for 3.8.0 with 9/9 checks passed
...
- `docs/releases/v3.8.0.md`: present
