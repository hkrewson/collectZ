...
- Version: `3.8.9`
- Generated: `2026-05-19T05:29:57.549Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.8.9
- Release note presence: PASS — docs/releases/v3.8.9.md
...
- Observability release evidence: PASS — observability artifact present for 3.8.9 with 9/9 checks passed
...
- `docs/releases/v3.8.9.md`: present
