...
- Version: `3.4.59`
- Generated: `2026-05-02T16:05:55.146Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.4.59
- Release note presence: PASS — docs/releases/v3.4.59.md
...
- Observability release evidence: PASS — observability artifact present for 3.4.59 with 9/9 checks passed
...
- `docs/releases/v3.4.59.md`: present
