...
- Version: `3.4.61`
- Generated: `2026-05-02T16:54:49.063Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.4.61
- Release note presence: PASS — docs/releases/v3.4.61.md
...
- Observability release evidence: PASS — observability artifact present for 3.4.61 with 9/9 checks passed
...
- `docs/releases/v3.4.61.md`: present
