...
- Version: `3.4.41`
- Generated: `2026-04-30T04:10:53.779Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.4.41
- Release note presence: PASS — docs/releases/v3.4.41.md
...
- Observability release evidence: PASS — observability artifact present for 3.4.41 with 9/9 checks passed
...
- `docs/releases/v3.4.41.md`: present
