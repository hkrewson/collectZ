...
- Version: `3.10.1`
- Generated: `2026-05-22T19:06:16.496Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.10.1
- Release note presence: PASS — docs/releases/v3.10.1.md
...
- Observability release evidence: PASS — observability artifact present for 3.10.1 with 9/9 checks passed
...
- `docs/releases/v3.10.1.md`: present
