...
- Version: `3.15.3`
- Generated: `2026-06-06T21:56:57.220Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.15.3
- Release note presence: PASS — docs/releases/v3.15.3.md
...
- Observability release evidence: PASS — observability artifact present for 3.15.3 with 9/9 checks passed
...
- `docs/releases/v3.15.3.md`: present
