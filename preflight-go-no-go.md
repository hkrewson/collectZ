...
- Version: `3.10.12`
- Generated: `2026-06-01T06:43:01.845Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.10.12
- Release note presence: PASS — docs/releases/v3.10.12.md
...
- Observability release evidence: PASS — observability artifact present for 3.10.12 with 9/9 checks passed
...
- `docs/releases/v3.10.12.md`: present
