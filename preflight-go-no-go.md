...
- Version: `3.8.7`
- Generated: `2026-05-19T04:21:59.227Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.8.7
- Release note presence: PASS — docs/releases/v3.8.7.md
...
- Observability release evidence: PASS — observability artifact present for 3.8.7 with 9/9 checks passed
...
- `docs/releases/v3.8.7.md`: present
