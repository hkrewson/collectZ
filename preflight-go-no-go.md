...
- Version: `3.4.123`
- Generated: `2026-05-08T04:43:07.281Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.4.123
- Release note presence: PASS — docs/releases/v3.4.123.md
...
- Observability release evidence: PASS — observability artifact present for 3.4.123 with 9/9 checks passed
...
- `docs/releases/v3.4.123.md`: present
