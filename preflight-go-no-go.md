...
- Version: `3.4.79`
- Generated: `2026-05-03T19:02:25.220Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.4.79
- Release note presence: PASS — docs/releases/v3.4.79.md
...
- Observability release evidence: PASS — observability artifact present for 3.4.79 with 9/9 checks passed
...
- `docs/releases/v3.4.79.md`: present
