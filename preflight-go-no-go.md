...
- Version: `3.4.113`
- Generated: `2026-05-07T04:17:43.971Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.4.113
- Release note presence: PASS — docs/releases/v3.4.113.md
...
- Observability release evidence: PASS — observability artifact present for 3.4.113 with 9/9 checks passed
...
- `docs/releases/v3.4.113.md`: present
