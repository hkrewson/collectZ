...
- Version: `3.16.36`
- Generated: `2026-06-11T04:43:59.678Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.16.36
- Release note presence: PASS — docs/releases/v3.16.36.md
...
- Observability release evidence: PASS — observability artifact present for 3.16.36 with 9/9 checks passed
...
- `docs/releases/v3.16.36.md`: present
