...
- Version: `3.23.18`
- Generated: `2026-07-13T21:41:23.023Z`
- Base URL: `http://localhost:3301`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.23.18
- Release note presence: PASS — docs/releases/v3.23.18.md
...
- Observability release evidence: PASS — observability artifact present for 3.23.18 with 9/9 checks passed
...
- `docs/releases/v3.23.18.md`: present
