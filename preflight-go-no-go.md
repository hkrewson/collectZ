...
- Version: `3.4.89`
- Generated: `2026-05-04T02:51:59.811Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.4.89
- Release note presence: PASS — docs/releases/v3.4.89.md
...
- Observability release evidence: PASS — observability artifact present for 3.4.89 with 9/9 checks passed
...
- `docs/releases/v3.4.89.md`: present
