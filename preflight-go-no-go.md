...
- Version: `3.4.101`
- Generated: `2026-05-05T06:10:42.562Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.4.101
- Release note presence: PASS — docs/releases/v3.4.101.md
...
- Observability release evidence: PASS — observability artifact present for 3.4.101 with 9/9 checks passed
...
- `docs/releases/v3.4.101.md`: present
