...
- Version: `3.4.67`
- Generated: `2026-05-02T20:32:04.225Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.4.67
- Release note presence: PASS — docs/releases/v3.4.67.md
...
- Observability release evidence: PASS — observability artifact present for 3.4.67 with 9/9 checks passed
...
- `docs/releases/v3.4.67.md`: present
