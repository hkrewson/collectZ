...
- Version: `3.9.14`
- Generated: `2026-05-21T21:22:44.028Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.9.14
- Release note presence: PASS — docs/releases/v3.9.14.md
...
- Observability release evidence: PASS — observability artifact present for 3.9.14 with 9/9 checks passed
...
- `docs/releases/v3.9.14.md`: present
