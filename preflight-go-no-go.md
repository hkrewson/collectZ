...
- Version: `3.4.49`
- Generated: `2026-05-01T04:44:28.522Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.4.49
- Release note presence: PASS — docs/releases/v3.4.49.md
...
- Observability release evidence: PASS — observability artifact present for 3.4.49 with 9/9 checks passed
...
- `docs/releases/v3.4.49.md`: present
