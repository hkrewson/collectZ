...
- Version: `3.14.1`
- Generated: `2026-06-06T06:16:56.598Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.14.1
- Release note presence: PASS — docs/releases/v3.14.1.md
...
- Observability release evidence: PASS — observability artifact present for 3.14.1 with 9/9 checks passed
...
- `docs/releases/v3.14.1.md`: present
