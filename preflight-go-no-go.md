...
- Version: `3.16.35`
- Generated: `2026-06-07T22:14:26.533Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.16.35
- Release note presence: PASS — docs/releases/v3.16.35.md
...
- Observability release evidence: PASS — observability artifact present for 3.16.35 with 9/9 checks passed
...
- `docs/releases/v3.16.35.md`: present
- Security triage markers: missing
