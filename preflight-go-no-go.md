...
- Version: `3.4.13`
- Generated: `2026-04-26T20:58:27.934Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.4.13
- Release note presence: PASS — docs/releases/v3.4.13.md
...
- Observability release evidence: PASS — observability artifact present for 3.4.13 with 9/9 checks passed
...
- `docs/releases/v3.4.13.md`: present
