...
- Version: `3.12.3`
- Generated: `2026-06-04T05:49:14.237Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.12.3
- Release note presence: PASS — docs/releases/v3.12.3.md
...
- Observability release evidence: PASS — observability artifact present for 3.12.3 with 9/9 checks passed
...
- `docs/releases/v3.12.3.md`: present
