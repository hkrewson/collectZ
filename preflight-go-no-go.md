...
- Version: `3.12.13`
- Generated: `2026-06-05T04:45:38.601Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.12.13
- Release note presence: PASS — docs/releases/v3.12.13.md
...
- Observability release evidence: PASS — observability artifact present for 3.12.13 with 9/9 checks passed
...
- `docs/releases/v3.12.13.md`: present
