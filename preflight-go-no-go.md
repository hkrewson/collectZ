...
- Version: `3.4.84`
- Generated: `2026-05-03T22:57:50.166Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.4.84
- Release note presence: PASS — docs/releases/v3.4.84.md
...
- Observability release evidence: PASS — observability artifact present for 3.4.84 with 9/9 checks passed
...
- `docs/releases/v3.4.84.md`: present
