...
- Version: `3.4.42`
- Generated: `2026-04-30T04:53:16.136Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.4.42
- Release note presence: PASS — docs/releases/v3.4.42.md
...
- Observability release evidence: PASS — observability artifact present for 3.4.42 with 9/9 checks passed
...
- `docs/releases/v3.4.42.md`: present
