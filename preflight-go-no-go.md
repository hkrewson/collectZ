...
- Version: `3.4.134`
- Generated: `2026-05-09T07:04:24.299Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.4.134
- Release note presence: PASS — docs/releases/v3.4.134.md
- Backend dependency audit: PASS — using existing audit artifact; low=0 moderate=2 high=0 critical=0
...
- Observability release evidence: PASS — observability artifact present for 3.4.134 with 9/9 checks passed
...
- `docs/releases/v3.4.134.md`: present
