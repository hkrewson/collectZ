...
- Version: `3.4.17`
- Generated: `2026-04-27T05:07:36.941Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.4.17
- Release note presence: PASS — docs/releases/v3.4.17.md
...
- Observability release evidence: PASS — observability artifact present for 3.4.17 with 9/9 checks passed
...
- `docs/releases/v3.4.17.md`: present
