...
- Version: `3.24.1`
- Generated: `2026-07-29T00:43:10.967Z`
- Base URL: `http://localhost:3301`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.24.1
- Release note presence: PASS — docs/releases/v3.24.1.md
...
- Observability release evidence: PASS — observability artifact present for 3.24.1 with 9/9 checks passed
...
- `docs/releases/v3.24.1.md`: present
