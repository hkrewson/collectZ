...
- Version: `3.8.3`
- Generated: `2026-05-18T05:51:59.565Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.8.3
- Release note presence: PASS — docs/releases/v3.8.3.md
...
- Observability release evidence: PASS — observability artifact present for 3.8.3 with 9/9 checks passed
...
- `docs/releases/v3.8.3.md`: present
