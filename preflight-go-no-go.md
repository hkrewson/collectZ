...
- Version: `3.16.33`
- Generated: `2026-06-07T21:04:52.524Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.16.33
- Release note presence: PASS — docs/releases/v3.16.33.md
...
- Observability release evidence: PASS — observability artifact present for 3.16.33 with 9/9 checks passed
...
- `docs/releases/v3.16.33.md`: present
