...
- Version: `3.4.125`
- Generated: `2026-05-08T05:59:08.960Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.4.125
- Release note presence: PASS — docs/releases/v3.4.125.md
...
- Observability release evidence: PASS — observability artifact present for 3.4.125 with 9/9 checks passed
...
- `docs/releases/v3.4.125.md`: present
