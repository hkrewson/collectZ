...
- Version: `3.4.60`
- Generated: `2026-05-02T16:27:01.373Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.4.60
- Release note presence: PASS — docs/releases/v3.4.60.md
...
- Observability release evidence: PASS — observability artifact present for 3.4.60 with 9/9 checks passed
...
- `docs/releases/v3.4.60.md`: present
