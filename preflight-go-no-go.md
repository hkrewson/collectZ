...
- Version: `3.4.50`
- Generated: `2026-05-01T05:17:48.850Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.4.50
- Release note presence: PASS — docs/releases/v3.4.50.md
...
- Observability release evidence: PASS — observability artifact present for 3.4.50 with 9/9 checks passed
...
- `docs/releases/v3.4.50.md`: present
