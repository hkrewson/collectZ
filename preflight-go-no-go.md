...
- Version: `3.19.4`
- Generated: `2026-06-20T04:00:08.319Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.19.4
- Release note presence: PASS — docs/releases/v3.19.4.md
...
- `docs/releases/v3.19.4.md`: present
