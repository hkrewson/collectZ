...
- Version: `3.16.20`
- Generated: `2026-06-07T07:10:09.859Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.16.20
- Release note presence: PASS — docs/releases/v3.16.20.md
...
- Observability release evidence: PASS — observability artifact present for 3.16.20 with 9/9 checks passed
...
- `docs/releases/v3.16.20.md`: present
