...
- Version: `3.4.55`
- Generated: `2026-05-02T04:31:01.987Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.4.55
- Release note presence: PASS — docs/releases/v3.4.55.md
...
- `docs/releases/v3.4.55.md`: present
