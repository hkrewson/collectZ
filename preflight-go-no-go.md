...
- Version: `3.4.65`
- Generated: `2026-05-02T19:05:19.240Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.4.65
- Release note presence: PASS — docs/releases/v3.4.65.md
...
- Observability release evidence: PASS — observability artifact present for 3.4.65 with 9/9 checks passed
...
- `docs/releases/v3.4.65.md`: present
