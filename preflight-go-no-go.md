...
- Version: `3.23.15`
- Generated: `2026-07-03T16:56:58.343Z`
- Base URL: `http://localhost:3201`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.23.15
- Release note presence: PASS — docs/releases/v3.23.15.md
...
- Observability release evidence: PASS — observability artifact present for 3.23.15 with 9/9 checks passed
...
- `docs/releases/v3.23.15.md`: present
