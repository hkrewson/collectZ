...
- Version: `3.23.21`
- Generated: `2026-07-22T16:40:01.290Z`
- Base URL: `http://localhost:3301`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.23.21
- Release note presence: PASS — docs/releases/v3.23.21.md
...
- `docs/releases/v3.23.21.md`: present
