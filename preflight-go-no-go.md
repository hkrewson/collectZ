...
- Version: `3.4.87`
- Generated: `2026-05-04T01:30:06.847Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.4.87
- Release note presence: PASS — docs/releases/v3.4.87.md
...
- Observability release evidence: PASS — observability artifact present for 3.4.87 with 9/9 checks passed
...
- `docs/releases/v3.4.87.md`: present
