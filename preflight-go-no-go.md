...
- Version: `3.16.34`
- Generated: `2026-06-07T21:17:08.473Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.16.34
- Release note presence: PASS — docs/releases/v3.16.34.md
...
- Observability release evidence: PASS — observability artifact present for 3.16.34 with 9/9 checks passed
...
- `docs/releases/v3.16.34.md`: present
