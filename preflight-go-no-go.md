...
- Version: `3.4.9`
- Generated: `2026-04-26T16:20:40.015Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.4.9
- Release note presence: PASS — docs/releases/v3.4.9.md
...
- Observability release evidence: PASS — observability artifact present for 3.4.9 with 9/9 checks passed
...
- `docs/releases/v3.4.9.md`: present
