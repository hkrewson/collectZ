...
- Version: `3.4.56`
- Generated: `2026-05-02T04:52:18.287Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.4.56
- Release note presence: PASS — docs/releases/v3.4.56.md
...
- Observability release evidence: PASS — observability artifact present for 3.4.56 with 9/9 checks passed
...
- `docs/releases/v3.4.56.md`: present
