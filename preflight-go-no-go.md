...
- Version: `3.4.116`
- Generated: `2026-05-07T04:56:24.601Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.4.116
- Release note presence: PASS — docs/releases/v3.4.116.md
...
- Observability release evidence: PASS — observability artifact present for 3.4.116 with 9/9 checks passed
...
- `docs/releases/v3.4.116.md`: present
