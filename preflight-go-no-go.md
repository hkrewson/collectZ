...
- Version: `3.15.4`
- Generated: `2026-06-06T22:14:13.496Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.15.4
- Release note presence: PASS — docs/releases/v3.15.4.md
...
- Observability release evidence: PASS — observability artifact present for 3.15.4 with 9/9 checks passed
...
- `docs/releases/v3.15.4.md`: present
