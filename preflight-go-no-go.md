...
- Version: `3.4.19`
- Generated: `2026-04-27T13:40:57.320Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.4.19
- Release note presence: PASS — docs/releases/v3.4.19.md
...
- Observability release evidence: PASS — observability artifact present for 3.4.19 with 9/9 checks passed
...
- `docs/releases/v3.4.19.md`: present
