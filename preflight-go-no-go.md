...
- Version: `3.4.37`
- Generated: `2026-04-29T23:45:09.046Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.4.37
- Release note presence: PASS — docs/releases/v3.4.37.md
...
- Observability release evidence: PASS — observability artifact present for 3.4.37 with 9/9 checks passed
...
- `docs/releases/v3.4.37.md`: present
