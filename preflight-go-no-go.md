...
- Version: `3.23.20`
- Generated: `2026-07-19T06:10:19.074Z`
- Base URL: `http://localhost:3301`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.23.20
- Release note presence: PASS — docs/releases/v3.23.20.md
...
- Observability release evidence: PASS — observability artifact present for 3.23.20 with 9/9 checks passed
...
- `docs/releases/v3.23.20.md`: present
