...
- Version: `3.4.98`
- Generated: `2026-05-05T05:12:48.675Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.4.98
- Release note presence: PASS — docs/releases/v3.4.98.md
...
- Observability release evidence: PASS — observability artifact present for 3.4.98 with 9/9 checks passed
...
- `docs/releases/v3.4.98.md`: present
