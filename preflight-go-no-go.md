...
- Version: `3.4.47`
- Generated: `2026-05-01T03:34:52.239Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.4.47
- Release note presence: PASS — docs/releases/v3.4.47.md
...
- Observability release evidence: PASS — observability artifact present for 3.4.47 with 9/9 checks passed
...
- `docs/releases/v3.4.47.md`: present
