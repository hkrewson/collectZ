...
- Version: `3.4.8`
- Generated: `2026-04-26T15:57:23.994Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.4.8
- Release note presence: PASS — docs/releases/v3.4.8.md
...
- Observability release evidence: PASS — observability artifact present for 3.4.8 with 9/9 checks passed
...
- `docs/releases/v3.4.8.md`: present
