...
- Version: `3.4.162`
- Generated: `2026-05-17T04:46:43.276Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.4.162
- Release note presence: PASS — docs/releases/v3.4.162.md
...
- Observability release evidence: PASS — observability artifact present for 3.4.162 with 9/9 checks passed
...
- `docs/releases/v3.4.162.md`: present
