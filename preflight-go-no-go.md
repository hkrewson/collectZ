...
- Version: `3.4.122`
- Generated: `2026-05-08T04:17:17.826Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.4.122
- Release note presence: PASS — docs/releases/v3.4.122.md
...
- Observability release evidence: PASS — observability artifact present for 3.4.122 with 9/9 checks passed
...
- `docs/releases/v3.4.122.md`: present
