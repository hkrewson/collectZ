...
- Version: `3.4.151`
- Generated: `2026-05-10T05:33:08.885Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.4.151
- Release note presence: PASS — docs/releases/v3.4.151.md
...
- Observability release evidence: PASS — observability artifact present for 3.4.151 with 9/9 checks passed
...
- `docs/releases/v3.4.151.md`: present
