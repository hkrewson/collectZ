...
- Version: `3.4.51`
- Generated: `2026-05-01T05:42:12.266Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.4.51
- Release note presence: PASS — docs/releases/v3.4.51.md
...
- Observability release evidence: PASS — observability artifact present for 3.4.51 with 9/9 checks passed
...
- `docs/releases/v3.4.51.md`: present
