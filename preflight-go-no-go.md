...
- Version: `3.4.80`
- Generated: `2026-05-03T19:27:30.988Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.4.80
- Release note presence: PASS — docs/releases/v3.4.80.md
...
- Observability release evidence: PASS — observability artifact present for 3.4.80 with 9/9 checks passed
...
- `docs/releases/v3.4.80.md`: present
