...
- Version: `3.16.9`
- Generated: `2026-06-07T03:09:23.081Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.16.9
- Release note presence: PASS — docs/releases/v3.16.9.md
...
- Observability release evidence: PASS — observability artifact present for 3.16.9 with 9/9 checks passed
...
- `docs/releases/v3.16.9.md`: present
