...
- Version: `3.12.4`
- Generated: `2026-06-04T06:10:30.589Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.12.4
- Release note presence: PASS — docs/releases/v3.12.4.md
...
- Observability release evidence: PASS — observability artifact present for 3.12.4 with 9/9 checks passed
...
- `docs/releases/v3.12.4.md`: present
