...
- Version: `3.4.152`
- Generated: `2026-05-10T06:41:46.746Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.4.152
- Release note presence: PASS — docs/releases/v3.4.152.md
...
- Observability release evidence: PASS — observability artifact present for 3.4.152 with 9/9 checks passed
...
- `docs/releases/v3.4.152.md`: present
