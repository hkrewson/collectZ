...
- Version: `3.4.107`
- Generated: `2026-05-06T06:17:19.373Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.4.107
- Release note presence: PASS — docs/releases/v3.4.107.md
...
- Observability release evidence: PASS — observability artifact present for 3.4.107 with 9/9 checks passed
...
- `docs/releases/v3.4.107.md`: present
