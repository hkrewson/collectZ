...
- Version: `3.7.2`
- Generated: `2026-05-18T02:01:04.119Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.7.2
- Release note presence: PASS — docs/releases/v3.7.2.md
...
- Observability release evidence: PASS — observability artifact present for 3.7.2 with 9/9 checks passed
...
- `docs/releases/v3.7.2.md`: present
