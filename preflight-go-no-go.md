...
- Version: `3.14.0`
- Generated: `2026-06-06T04:34:43.380Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.14.0
- Release note presence: PASS — docs/releases/v3.14.0.md
...
- Observability release evidence: PASS — observability artifact present for 3.14.0 with 9/9 checks passed
...
- `docs/releases/v3.14.0.md`: present
