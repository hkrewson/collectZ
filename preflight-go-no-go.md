...
- Version: `3.23.9`
- Generated: `2026-07-03T14:42:08.160Z`
- Base URL: `http://localhost:3201`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.23.9
- Release note presence: PASS — docs/releases/v3.23.9.md
...
- Observability release evidence: PASS — observability artifact present for 3.23.9 with 9/9 checks passed
...
- `docs/releases/v3.23.9.md`: present
