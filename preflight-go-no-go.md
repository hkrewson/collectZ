...
- Version: `3.13.0`
- Generated: `2026-06-05T23:17:17.154Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.13.0
- Release note presence: PASS — docs/releases/v3.13.0.md
...
- Observability release evidence: PASS — observability artifact present for 3.13.0 with 9/9 checks passed
...
- `docs/releases/v3.13.0.md`: present
