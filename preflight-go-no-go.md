...
- Version: `3.16.0`
- Generated: `2026-06-06T22:38:03.108Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.16.0
- Release note presence: PASS — docs/releases/v3.16.0.md
...
- Observability release evidence: PASS — observability artifact present for 3.16.0 with 9/9 checks passed
...
- `docs/releases/v3.16.0.md`: present
