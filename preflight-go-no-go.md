...
- Version: `3.4.97`
- Generated: `2026-05-05T04:53:20.047Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.4.97
- Release note presence: PASS — docs/releases/v3.4.97.md
...
- Observability release evidence: PASS — observability artifact present for 3.4.97 with 9/9 checks passed
...
- `docs/releases/v3.4.97.md`: present
