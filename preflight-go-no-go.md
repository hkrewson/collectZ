...
- Version: `3.8.20`
- Generated: `2026-05-20T03:27:49.658Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.8.20
- Release note presence: PASS — docs/releases/v3.8.20.md
...
- `docs/releases/v3.8.20.md`: present
