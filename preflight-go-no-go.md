...
- Version: `3.8.13`
- Generated: `2026-05-19T20:35:12.954Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.8.13
- Release note presence: PASS — docs/releases/v3.8.13.md
...
- `docs/releases/v3.8.13.md`: present
