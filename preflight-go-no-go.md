...
- Version: `3.19.5`
- Generated: `2026-06-20T04:42:41.255Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.19.5
- Release note presence: PASS — docs/releases/v3.19.5.md
...
- `docs/releases/v3.19.5.md`: present
