...
- Version: `3.9.15`
- Generated: `2026-05-21T21:45:27.981Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.9.15
- Release note presence: PASS — docs/releases/v3.9.15.md
...
- Observability release evidence: PASS — observability artifact present for 3.9.15 with 9/9 checks passed
...
- `docs/releases/v3.9.15.md`: present
