...
- Version: `3.24.5`
- Generated: `2026-08-02T00:27:55.128Z`
- Base URL: `http://localhost:3201`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.24.5
- Release note presence: PASS — docs/releases/v3.24.5.md
...
- Observability release evidence: PASS — observability artifact present for 3.24.5 with 9/9 checks passed
...
- `docs/releases/v3.24.5.md`: present
