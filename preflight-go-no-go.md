...
- Version: `3.9.3`
- Generated: `2026-05-20T23:05:39.368Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.9.3
- Release note presence: PASS — docs/releases/v3.9.3.md
...
- `docs/releases/v3.9.3.md`: present
