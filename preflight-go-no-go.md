...
- Version: `3.4.124`
- Generated: `2026-05-08T05:21:16.436Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.4.124
- Release note presence: PASS — docs/releases/v3.4.124.md
...
- Observability release evidence: PASS — observability artifact present for 3.4.124 with 9/9 checks passed
...
- `docs/releases/v3.4.124.md`: present
