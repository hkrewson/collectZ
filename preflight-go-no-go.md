...
- Version: `3.4.148`
- Generated: `2026-05-09T23:34:39.216Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.4.148
- Release note presence: PASS — docs/releases/v3.4.148.md
...
- Observability release evidence: PASS — observability artifact present for 3.4.148 with 9/9 checks passed
...
- `docs/releases/v3.4.148.md`: present
