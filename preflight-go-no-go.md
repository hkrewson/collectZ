...
- Version metadata sync: PASS — all manifests aligned on 3.4.150
- Release note presence: PASS — docs/releases/v3.4.150.md
...
- Observability release evidence: PASS — observability artifact present for 3.4.150 with 9/9 checks passed
...
- `docs/releases/v3.4.150.md`: present
