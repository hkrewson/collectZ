...
- Version: `3.2.5`
- Generated: `2026-04-21T04:06:43.166Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.2.5
- Release note presence: PASS — docs/releases/v3.2.5.md
...
- Observability release evidence: PASS — observability artifact present for 3.2.5 with 9/9 checks passed
...
- `docs/releases/v3.2.5.md`: present
