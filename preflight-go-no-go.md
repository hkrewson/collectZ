...
- Version: `3.23.4`
- Generated: `2026-07-03T05:41:09.262Z`
- Base URL: `http://localhost:3201`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.23.4
- Release note presence: PASS — docs/releases/v3.23.4.md
...
- Observability release evidence: PASS — observability artifact present for 3.23.4 with 9/9 checks passed
...
- `docs/releases/v3.23.4.md`: present
