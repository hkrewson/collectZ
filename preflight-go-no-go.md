...
- Version: `3.18.0`
- Generated: `2026-06-11T13:49:38.850Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.18.0
- Release note presence: PASS — docs/releases/v3.18.0.md
...
- Observability release evidence: PASS — observability artifact present for 3.18.0 with 9/9 checks passed
...
- `docs/releases/v3.18.0.md`: present
