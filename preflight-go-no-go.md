...
- Version: `3.21.0`
- Generated: `2026-06-26T06:28:45.326Z`
- Base URL: `http://localhost:3201`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.21.0
- Release note presence: PASS — docs/releases/v3.21.0.md
...
- Observability release evidence: PASS — observability artifact present for 3.21.0 with 9/9 checks passed
...
- `docs/releases/v3.21.0.md`: present
