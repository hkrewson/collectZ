...
- Version: `3.24.2`
- Generated: `2026-07-31T23:34:00.354Z`
- Base URL: `http://localhost:3301`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.24.2
- Release note presence: PASS — docs/releases/v3.24.2.md
...
- Observability release evidence: PASS — observability artifact present for 3.24.2 with 9/9 checks passed
...
- `docs/releases/v3.24.2.md`: present
