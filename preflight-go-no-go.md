...
- Version: `3.4.12`
- Generated: `2026-04-26T19:26:32.101Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.4.12
- Release note presence: PASS — docs/releases/v3.4.12.md
...
- Observability release evidence: PASS — observability artifact present for 3.4.12 with 9/9 checks passed
...
- `docs/releases/v3.4.12.md`: present
