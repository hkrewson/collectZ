...
- Version: `3.4.94`
- Generated: `2026-05-04T06:49:53.122Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.4.94
- Release note presence: PASS — docs/releases/v3.4.94.md
...
- Observability release evidence: PASS — observability artifact present for 3.4.94 with 9/9 checks passed
...
- `docs/releases/v3.4.94.md`: present
