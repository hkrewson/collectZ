...
- Version: `3.12.2`
- Generated: `2026-06-04T05:07:29.880Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.12.2
- Release note presence: PASS — docs/releases/v3.12.2.md
...
- Observability release evidence: PASS — observability artifact present for 3.12.2 with 9/9 checks passed
...
- `docs/releases/v3.12.2.md`: present
