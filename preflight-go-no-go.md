...
- Version: `3.4.137`
- Generated: `2026-05-09T15:06:27.083Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.4.137
- Release note presence: PASS — docs/releases/v3.4.137.md
...
- Observability release evidence: PASS — observability artifact present for 3.4.137 with 9/9 checks passed
...
- `docs/releases/v3.4.137.md`: present
