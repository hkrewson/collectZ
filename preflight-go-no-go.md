...
- Version: `3.24.0`
- Generated: `2026-07-27T03:07:57.981Z`
- Base URL: `http://127.0.0.1:3301`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.24.0
- Release note presence: PASS — docs/releases/v3.24.0.md
...
- Observability release evidence: PASS — observability artifact present for 3.24.0 with 9/9 checks passed
...
- `docs/releases/v3.24.0.md`: present
