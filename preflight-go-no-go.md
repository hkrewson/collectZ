...
- Version: `3.4.45`
- Generated: `2026-05-01T01:08:41.466Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.4.45
- Release note presence: PASS — docs/releases/v3.4.45.md
...
- Observability release evidence: PASS — observability artifact present for 3.4.45 with 9/9 checks passed
...
- `docs/releases/v3.4.45.md`: present
