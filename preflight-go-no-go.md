...
- Version: `3.18.3`
- Generated: `2026-06-12T05:40:47.388Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.18.3
- Release note presence: PASS — docs/releases/v3.18.3.md
...
- Observability release evidence: PASS — observability artifact present for 3.18.3 with 9/9 checks passed
...
- `docs/releases/v3.18.3.md`: present
