...
- Version: `3.2.6`
- Generated: `2026-04-21T05:36:48.093Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.2.6
- Release note presence: PASS — docs/releases/v3.2.6.md
...
- Observability release evidence: PASS — observability artifact present for 3.2.6 with 9/9 checks passed
...
- `docs/releases/v3.2.6.md`: present
