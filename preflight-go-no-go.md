...
- Version: `3.4.90`
- Generated: `2026-05-04T03:13:59.600Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.4.90
- Release note presence: PASS — docs/releases/v3.4.90.md
...
- Observability release evidence: PASS — observability artifact present for 3.4.90 with 9/9 checks passed
...
- `docs/releases/v3.4.90.md`: present
