...
- Version: `3.4.69`
- Generated: `2026-05-02T21:35:39.295Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.4.69
- Release note presence: PASS — docs/releases/v3.4.69.md
...
- Observability release evidence: PASS — observability artifact present for 3.4.69 with 9/9 checks passed
...
- `docs/releases/v3.4.69.md`: present
