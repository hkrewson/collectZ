...
- Version: `3.14.5`
- Generated: `2026-06-06T08:16:44.899Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.14.5
- Release note presence: PASS — docs/releases/v3.14.5.md
...
- Observability release evidence: PASS — observability artifact present for 3.14.5 with 9/9 checks passed
...
- `docs/releases/v3.14.5.md`: present
