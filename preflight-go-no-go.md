...
- Version: `3.18.5`
- Generated: `2026-06-13T06:38:29.890Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.18.5
- Release note presence: PASS — docs/releases/v3.18.5.md
...
- Observability release evidence: PASS — observability artifact present for 3.18.5 with 9/9 checks passed
...
- `docs/releases/v3.18.5.md`: present
