...
- Version: `3.23.19`
- Generated: `2026-07-19T05:00:03.771Z`
- Base URL: `http://localhost:3301`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.23.19
- Release note presence: PASS — docs/releases/v3.23.19.md
...
- Observability release evidence: PASS — observability artifact present for 3.23.19 with 9/9 checks passed
...
- `docs/releases/v3.23.19.md`: present
