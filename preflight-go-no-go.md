...
- Version: `3.11.0`
- Generated: `2026-06-03T16:44:39.583Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.11.0
- Release note presence: PASS — docs/releases/v3.11.0.md
...
- Observability release evidence: PASS — observability artifact present for 3.11.0 with 9/9 checks passed
...
- `docs/releases/v3.11.0.md`: present
