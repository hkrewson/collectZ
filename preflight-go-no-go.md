...
- Version: `3.9.0`
- Generated: `2026-05-20T06:06:11.736Z`
- Base URL: `http://localhost:3000`

## Gate Results

- Version metadata sync: PASS — all manifests aligned on 3.9.0
- Release note presence: PASS — docs/releases/v3.9.0.md
...
- `docs/releases/v3.9.0.md`: present
